...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const base = (import.meta.env && import.meta.env.VITE_API_URL) || "https://true-drive-rentals-backend.onrender.com";
          ...
          <div className={loginStyles.loginCard.headerContainer}>
            <div className={loginStyles.loginCard.logoContainer}>
              <div className={loginStyles.loginCard.logoText}>
                ...
                />
                <span className="font-bold tracking-wider">True-Drive-Rental</span>
              </div>
            </div>
